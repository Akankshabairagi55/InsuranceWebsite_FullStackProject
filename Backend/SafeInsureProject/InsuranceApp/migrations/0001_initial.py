    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('age', models.IntegerField(blank=True, null=True)),
                ('mobile', models.CharField(blank=True, max_length=15, null=True)),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nominees', to='InsuranceApp.customer')),
            ],
        ),
        migrations.CreateModel(
            name='PolicyPurchase',
            fields=[
                ...
                ('nominee_of_policy', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nominee_detail', to='InsuranceApp.nominee')),
